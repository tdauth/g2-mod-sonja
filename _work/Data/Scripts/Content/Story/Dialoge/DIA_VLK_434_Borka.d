...
func void DIA_Borka_Smoke_Info ()
{
    ...
    {
        AI_Output (self, other, "DIA_Borka_Smoke_11_02"); //Nein Boss.
    };
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
...
//	Info NEW BOSS
///////////////////////////////////////////////////////////////////////
instance DIA_Borka_NEW_BOSS		(C_INFO)
{
	npc			 = 	VLK_434_Borka;
	nr			 = 	3;
	condition	 = 	DIA_Borka_NEW_BOSS_Condition;
	information	 = 	DIA_Borka_NEW_BOSS_Info;
	permanent	 =  TRUE;
	description	 = 	"Du arbeitest jetzt für mich.";
};
func int DIA_Borka_NEW_BOSS_Condition ()
{
	return Bromor_RoteTaverneVerkauft;
};
func void DIA_Borka_NEW_BOSS_Info ()
{
	AI_Output (other, self, "DIA_Borka_NEW_BOSS_15_00"); //Du arbeitest jetzt für mich.
	AI_Output (self, other, "DIA_Borka_NEW_BOSS_11_01"); //Geht klar Boss!
};
