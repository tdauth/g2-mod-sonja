...
{
	if (Nadja_LuciaInfo == TRUE && Bromor_RoteTaverneVerkauft == FALSE)
	{
...
{	
	if (Bromor_Pay == 1 || Bromor_RoteTaverneVerkauft) // Sonja
	{
		return TRUE;
	};
};
...
{	
	if (Bromor_Pay == 2 || Bromor_RoteTaverneVerkauft == TRUE)
