...
func void DIA_Bromor_BUYASK_Info ()
{
	...
	AI_Output (self, other, "DIA_Bromor_BUYASK_07_01"); //Du willst was? Bist du verrückt? Ich verdiene damit meinen Lebensunterhalt. Da müsstest du mir schon eine Menge Gold bezahlen.
	AI_Output (other, self, "DIA_Bromor_BUYASK_15_01"); //Was wenn ich genug habe?
	AI_Output (self, other, "DIA_Bromor_BUYASK_07_02"); //Das glaubst du doch selbst nicht. Für 15 000 Goldmünzen vermache ich dir die Rote Laterne. Aber nur wenn du auf mich einen vertrauenswürdigen Eindruck gemacht hast.

	Log_CreateTopic ("Die Rote Laterne", LOG_NOTE);
	B_LogEntry ("Die Rote Laterne", "Bromor wird mir die Rote Laterne für 15 000 Goldmünzen verkaufen, falls ich bis dahin sein Vertrauen gewonnen habe.");
};
...
instance DIA_Bromor_BUY		(C_INFO)
{
	...
	permanent	 =  TRUE;
	description	 = 	"Überlasse mir die Rote Laterne!";
};
...
{
	AI_Output (other, self, "DIA_Bromor_BUY_15_00"); //Überlasse mir die Rote Laterne!
	...
	{
        AI_Output (self, other, "DIA_Bromor_BUY_07_03"); //Du hast mir meine Goldene Schale nicht zurück gebracht!
	}
...
{
	AI_Output (other, self, "DIA_Bromor_NEW_LIFE_15_00"); //Wie läufts?
	AI_Output (self, other, "DIA_Bromor_NEW_LIFE_07_01"); //Ich kann mich nicht beklagen. Dein Geld hat mir das Leben im oberen Viertel ermöglicht.
};
