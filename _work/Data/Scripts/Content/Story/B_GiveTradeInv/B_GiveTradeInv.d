...
//******************************************************************	
    ...
    // Sonja
    var C_NPC Trd_Sonja;		Trd_Sonja		= Hlp_GetNpc (VLK_436_Sonja);
...
//********************************************************************
	...
	{
        // Sonja
        if  Hlp_GetInstanceID (slf) == Hlp_GetInstanceID (Trd_Sonja)	{B_ClearJunkTradeInv (slf); B_GiveTradeInv_Sonja	(slf);};
	...
	{
        // Sonja
        if  Hlp_GetInstanceID (slf) == Hlp_GetInstanceID (Trd_Sonja)		{B_ClearDeadTrader	(slf);};
