...
// 									AUFREISSEN
// *************************************************************************
INSTANCE DIA_VLK_16_AUFREISSEN(C_INFO)
{
	nr			= 90;
	condition	= DIA_VLK_16_AUFREISSEN_Condition;
	information	= DIA_VLK_16_AUFREISSEN_Info;
	permanent	= TRUE;
	description = "(Aufreißen)";
};
func INT DIA_VLK_16_AUFREISSEN_Condition()
{
	return TRUE;
};

FUNC VOID DIA_VLK_16_AUFREISSEN_Info()
{
    B_Aufreissen();
};
...
FUNC VOID B_AssignAmbientInfos_VLK_16 (var c_NPC slf)
{
	...
	DIA_VLK_16_AUFREISSEN.npc			= Hlp_GetInstanceID(slf);
};
